...
При запуске МОНИТОР проводит проверку наличия оборудования и, в зависимости
от его наличия, выполняет следующие действия:

- При обнаружении ROM-диска передается управление программе управления ROM-диском
- При отсутствиии ROM-диска проводится проверка наличия РК-ДОС и, при ее наличии,
  управление передается РК-ДОС
- При отсутствиии РК-ДОС управление передается интерактивной части МОНИТОРа.
