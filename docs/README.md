...
Перехватывая стандартные п/п можно обеспечить совместимость с имеющими программами
без перепрошивания МОНИТОРа. Перехват чтения клавиатуры позволяет установить драйвер
...
эмулятора терминала (например, VT-100) или организации оконного менеджера.
