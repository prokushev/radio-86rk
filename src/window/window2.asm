...
FRTEXT:	DB	03H+5eh, 0		; ВЕРХНЯЯ СТОРОНА
	DB	8,7+5eh,1AH, 8, 0 	; УГОЛ
	DB	06H+5eh, 1AH, 8, 0 	; ПРАВАЯ СТОРОНА
	DB	16h+5eh, 8, 8, 0	; УГОЛ
	DB	14H+5eh, 8, 8, 0	; НИЖНЯЯ СТОРОНА
	DB	18H,15h+5eh, 8,19H,0	; УГОЛ
	DB	11H+5eh, 19H, 8, 0	;ЛЕВАЯ СТОРОНА
	DB	13h+5eh, 1AH,0		; Угол+КУРСОР В ЛЕВЫЙ ВЕРХНИЙ УГОЛ
