...
- Стандартный журнальный вариант Радио86-РК
...
- МОНИТОР-М/80К для МИКРО-80, совместимый с Радио86-РК [Радио 1989 год №11]
...
аппаратного обеспечения Радио86-РК. От минимальной конфигурации с ОЗУ 16кб,
...
- Поправить доку в части использования '.' для прерывания команды
- Добавить дисковые функции CP/M для работы с ROM-диском
- функция ввода строки в буфер неправильно отрабатывает размер