# МОНИТОР-1.20 для Радио-86РК для КР580, VT-52, совместимый с Орион-128
...
## ПЛАНИРУЕМЫЕ ИЗМЕНЕНИЯ В ВЕРСИИ 1.21
 ...
 - [ ] Доработать ввод строки до совместимости с CP/M
 - [ ] Доработать R для работы без параметров
